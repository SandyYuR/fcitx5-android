...
## 相对于 fxliang/fcitx5-android 的改动

本分支以 fxliang 的 `fx2` 分支、提交 `3ad25fc9` 为基线。除了 Rime-only 专用化，还保留并继续完善了大量性能、稳定性和安全修复：
...
详细历史和维护注意事项见 [交接文档](docs/HANDOVER-rime-only.md)。
