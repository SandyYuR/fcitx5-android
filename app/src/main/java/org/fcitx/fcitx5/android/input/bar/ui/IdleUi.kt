...
class IdleUi(
     ...
     * status, password number row, clipboard/search pages, extended windows — from leaving the
     * strip on a page that draws nothing while the fixed edge buttons stay visible.
     */
