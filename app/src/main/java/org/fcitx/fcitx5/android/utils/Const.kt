...
object Const {
    ...
    // Repository this build is made from; also the source of update checks
    // (see UpdateRepository.fetchLatestRelease) and the About page links.
    const val githubRepo = "https://github.com/SandyYuR/fcitx5-android"
